        ...
        <div className="bg-brand-bg min-h-screen text-brand-text-primary font-sans flex items-center justify-center p-4">
            <div className="bg-brand-surface border border-brand-border rounded-xl p-8 max-w-lg w-full text-center animate-fade-in">
                ...
                <p className="mt-4 text-brand-text-secondary">
                    To connect to the advanced diagnostic models, you need to select a Google AI API key.
                </p>
                <button
                ...
                <p className="text-xs text-brand-text-secondary/70 mt-4 text-center">
                    Your key is required to perform diagnostics. For more information, see the <a href="https://ai.google.dev/gemini-api/docs/billing" target="_blank" rel="noopener noreferrer" className="underline hover:text-brand-accent">billing documentation</a>.
                </p>
            </div>
        </div>
    );
